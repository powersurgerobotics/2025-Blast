...
async def runMission():
    yaw_value = 0
    speed_percent = 75
    await Gyro_Move_Forward_By_Distance(yaw_value,15,speed_percent) # Move Straight until the specified distance point and stop.
    await Move_Right_Attachment_Forward(40, 32)
