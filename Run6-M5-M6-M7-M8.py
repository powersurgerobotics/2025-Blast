...
async def runMission():
    yaw_value = 0
    speed_percent = 65
    await Gyro_Move_Forward_By_Distance(yaw_value,27.4,speed_percent) # Move Straight until the specified distance point and stop.
    ...
    await Move_Left_Attachment_Backward(45, 47)
