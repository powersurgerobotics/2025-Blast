...
async def runMission():
    ...
    speed_percent = 35
    await Gyro_Move_Backward_By_Distance(yaw_value,4.5,speed_percent) # Move Straight until the specified distance point and stop.
    await Gyro_Move_Forward_By_Distance(yaw_value,2.5,speed_percent) # Move Straight until the specified distance point and stop.
